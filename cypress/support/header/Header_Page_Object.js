...
export default class Header_Page_Object{
    brand_heading_validation(){
       ...
       cy.get(user.header_elements.brand_heading).should('have.css','cursor','pointer');
       // should be wrapped within link tag
       cy.get(user.header_elements.brand_heading).should('have.attr','href')
       // link should not be empty
       cy.get(user.header_elements.brand_heading).should('have.attr','href').should('not.be.empty');
    }
    ...
    login_link_validation(){
        ...
        //should display cursor as pointer
        cy.get(user.header_elements.login_link).should('have.css','cursor','pointer'); 
        //should be wrapped within link tag
        cy.get(user.header_elements.login_link).should('have.attr','href');
        //link should not be empty
        cy.get(user.header_elements.login_link).should('have.attr','href').should('not.be.empty');
    }
    ...
    shop_link_validation(){
        ...
        //should display cursor as pointer
        cy.get(user.header_elements.shop_link).should('have.css','cursor','pointer');
        //should be wrapped within link tag
        cy.get(user.header_elements.login_link).should('have.attr','href');
    ...
    wishlist_link_validation(){
        ...
        //should display cursor as pointer
        cy.get(user.header_elements.wishlist_link).should('have.css','cursor','pointer');
        //should be wrapped within link tag
        cy.get(user.header_elements.wishlist_link).should('have.attr','href');
        //link value should not be empty
        cy.get(user.header_elements.wishlist_link).should('have.attr','href').should('not.be.empty');
    }
    ...
    cart_link_validation(){
        ...
        //should display cursor as pointer
        cy.get(user.header_elements.cart_link).should('have.css','cursor','pointer');
        //should be wrapped within link tag
        cy.get(user.header_elements.cart_link).should('have.attr','href');
        //link value should not be empty
        cy.get(user.header_elements.cart_link).should('have.attr','href').should('not.be.empty');  
    }
   ...
   order_link_validation(){
        ...
        //should display cursor as pointer
        cy.get(user.header_elements.order_link).should('have.css','cursor','pointer');
        //should be wrapped within link tag
        cy.get(user.header_elements.order_link).should('have.attr','href');
        //link value should not be empty
        cy.get(user.header_elements.order_link).should('have.attr','href').should('not.be.empty'); 
   }
